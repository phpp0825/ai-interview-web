...
class STTClient:
    ...
    def __init__(self, config: Optional[STTConfig] = None):
        ...
        try:
            # Initialize Whisper model with enhanced settings
            ...
            logger.warning(f"Failed to load model {self.config.model_name}, falling back to base model: {e}")
            # 대용량 모델 로드 실패 시 기본 모델로 폴백
            self.model = WhisperModel(
